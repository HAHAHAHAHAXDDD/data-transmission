...
pub fn draw_plot(v1: Vec<(f64, f64)>, xlim0:f64, xlim1:f64, ylim0:f64, ylim1:f64, name: String)  -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut chart = ChartBuilder::on(&root)
        ...
        chart
            .configure_mesh()
            .x_desc("Parametr α")
            .y_desc("Współczynnik BER")
            .axis_desc_style(("sans-serif", (4.2).percent_height()))
            .draw()?;
